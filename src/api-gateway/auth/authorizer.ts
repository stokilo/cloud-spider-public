...
function generatePolicyStatement (isAllowed: boolean, methodArn: string): PolicyDocument {
  ...
  // arn:aws:execute-api:me-south-1:262280523204:1d8uw6x4fg/$default/GET/listing ==>
  // arn:aws:execute-api:me-south-1:262280523204:1d8uw6x4fg/$default/*/listing
  ...
  const arnSplit = parsedMethodArn.resource.split('/')
  arnSplit[arnSplit.length - 1] = '*'
  parsedMethodArn.resource = arnSplit.join('/')
